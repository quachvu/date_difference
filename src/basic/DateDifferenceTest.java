...
//		Scanner sc = new Scanner(new FileReader(currDir+"/src/basic/DateInputForTestCase.txt"));// For using 
//		IDE such as Eclipse other than just run from Command Line because the "src" is source package and is invisible to the System.
		Scanner sc = new Scanner(new FileReader(currDir+"/DateInputForTestCase.txt"));
		while(sc.hasNext()){
